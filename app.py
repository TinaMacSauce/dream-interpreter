# app.py — Jamaican True Stories Dream Interpreter (SSE + Level 4 Seal Engine)
# Features:
...
# - Seal-specific tone (warning / instruction / confirmation) ✅ NEW
# - Dream Receipt share_phrase optimized for captions ✅ NEW
...
# Tabs (Sheets)
SYMBOLS_WORKSHEET_NAME = os.environ.get("SYMBOLS_WORKSHEET_NAME", os.environ.get("WORKSHEET_NAME", "Sheet1")).strip()
...
EMAIL_GATE_AT = int(os.environ.get("EMAIL_GATE_AT", "4"))  # when to request email (after free quota)
...
# AI Voice toggle (this is the NEW switch)
...
# =========================
# DREAM RECEIPT SHARE PHRASE (NEW)
# =========================
...
# =========================
# AI VOICE POLISHER (UPDATED to accept tone)
# =========================
...
def interpret():
    ...
    if is_paid_user:
        ...
        # NEW: polish final interpretation using AI Voice (writing only) + seal tone
