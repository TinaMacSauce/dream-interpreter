...
# Allowed Shopify/front-end origins (edit to match EXACT storefront URLs)
ALLOWED_ORIGINS = [
...
# === OPTIONAL: allow embedding in an <iframe> from your shop/domain ===
# If you embed the WHOLE app in an <iframe>, uncomment this block.
# @app.after_request
# def add_csp(resp):
