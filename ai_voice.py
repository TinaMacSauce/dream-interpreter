...
"""
    ...
    # If the model returns blanks (rare), fallback to parsing from doctrine_summary itself
    # (doctrine_summary is already labeled in your app.py)
    ...
    # Rebuild clean, guaranteed structure
    final_output = (
