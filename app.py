...
1. Copy this entire file into your project as `app.py` (replace the old one).  
2. Commit + push to GitHub.  
3. In Render → your service → **Manual Deploy → Clear build cache & Deploy**.  
4. After it deploys, hit:

```text
https://dream-interpreter-smnc.onrender.com/refresh
