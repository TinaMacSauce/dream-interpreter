...
def get_behavior_name(row: Dict[str, Any]) -> str:
    return get_rule_name(row, "behavior_name", "behavior", "name")
...
def get_behavior_rule_class(row: Dict[str, Any]) -> str:
    return row_get(row, "rule_class", "rule class", "class")


def behavior_is_attack(row: Dict[str, Any]) -> bool:
    raw = row_get(row, "is_attack", "is attack", "attack")
...
def get_state_name(row: Dict[str, Any]) -> str:
    return get_rule_name(row, "state_name", "state", "name")
...
def get_location_name(row: Dict[str, Any]) -> str:
    return get_rule_name(row, "location_name", "location", "name")
...
def get_relationship_name(row: Dict[str, Any]) -> str:
    return get_rule_name(row, "relationship_name", "relationship", "name")
...
def relationship_literal_when_peaceful(row: Dict[str, Any]) -> bool:
    raw = row_get(row, "literal_when_peaceful", "literal when peaceful")
    if not raw:
        return False
    return normalize_yes_no(raw)
