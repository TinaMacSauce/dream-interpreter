# app.py — Jamaican True Stories Dream Interpreter (Phase 2.8.1 — STRICT + DEBUG + COMPOUND GUARD)
# Fixes:
# - Prevents "running" from triggering "horse running" / "running naked"
# - Multi-word symbols ONLY match when the full phrase is present
# - Keywords ONLY allowed to trigger single-word symbols (optional but recommended)
