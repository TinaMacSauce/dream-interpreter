...
def interpret():
    ...
    if used >= FREE_QUOTA:
        base = ""  # frontend builds full URL; this is just for debug or legacy
...
def create_checkout():
    ...
    Frontend JS is responsible for redirecting the user back to Shopify.
    """
    ...
    # Where to send them after successful Stripe checkout
    # This is your Shopify interpreter page with a query flag:
    success_url = "https://jamaicantruestories.com/pages/dream-interpreter?sub_success=1"
    cancel_url  = "https://jamaicantruestories.com/pages/dream-interpreter"
...
def stripe_success():
    """
    (Legacy endpoint if you ever want to land on backend first.)
