...
# === CORS (GLOBAL) ===
# Apply CORS to ALL routes so responses include Access-Control-Allow-Origin.
# This fixes the 'Response Headers (0)' you saw in DevTools.
CORS(
    app,
    origins=ALLOWED_ORIGINS,          # global allow-list
