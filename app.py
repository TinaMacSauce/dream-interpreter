...
def build_full_interpretation_from_doctrine(matches: List[Tuple[Dict, int, Optional[Dict[str, str]]]]) -> str:
    ...
    # Symbol meaning sentences (clean, consistent)
    ...
    # Effects (per symbol, avoids repetitive “This can…” spam)
    ...
    # Paragraph breaks for your UI container (use CSS white-space: pre-line)
